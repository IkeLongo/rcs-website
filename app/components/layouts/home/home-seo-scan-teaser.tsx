...
import { BackgroundLines } from "../../ui/backgrounds/background-lines";
import SeoScanForm from "./seo-scan-form";
        ...
        <div className="mx-auto max-w-6xl w-full flex flex-col items-center justify-center">
          <div className="px-6 py-10 md:px-10 md:py-12 w-full">
            <div className="text-center">
              ...
              <p className="mt-3 text-sm md:!text-md2 text-grey-600 max-w-2xl mx-auto">
