...
export default function Cookies() {
  ...
  return (
    <section className='pb-8 max-w-[60em] !text-white'>
      <h4 className="my-2 !text-white">What is a Cookie?</h4>
      <p className="text-left pb-4 !text-white">A cookie is a small data file stored in your computer, tablet or smartphone. A cookie is not a program and cannot carry harmful malware or viruses.</p>
      <h4 className="my-2 !text-white">How Our Website Utilizes Cookies</h4>
      <p className="text-left pb-4 !text-white">Cookies are essential for certain functionalities of our website. They also give us insights into your visit, allowing us to continuously improve and tailor your experience based on your preferences and interests. For instance, cookies help remember items in your shopping cart, whether you've visited before, your login status, and your preferred language or currency. Additionally, cookies enable us to personalize advertisements for you on other platforms. Overall, cookies enhance our services by providing you with relevant content.</p>
      <p className="text-left !text-white">We categorize the use of cookies into three main areas:</p>
      ...
      <h4 className="my-2 !text-white">Cookie Storage Duration</h4>
      <p className="text-left pb-4 !text-white">The storage duration of cookies varies based on the specific type and the time of your last visit. Once a cookie expires, it is automatically deleted. The lifespan of each cookie is outlined in our cookie policy.</p>
      <h4 className="my-2 !text-white">Managing or Deleting Cookies</h4>
      <p className="text-left pb-4 !text-white">You can block all or specific third-party cookies at any time by adjusting your browser settings on your device. The exact process depends on your browser (e.g., Chrome, Firefox, Safari) and device type (e.g., desktop, tablet, smartphone). However, blocking cookies may impact certain features and services on our website that rely on them. <a href="https://tools.google.com/dlpage/gaoptout" className="text-royal-blue-500 hover:underline">You can opt-out of cookies from Google Analytics here</a>.</p>
      <h4 className="my-2 !text-white">How to Delete Cookies</h4>
      <p className="text-left pb-4 !text-white">If you've previously accepted cookies, you can remove them at any time. The steps vary depending on the browser and device you're using:</p>
      ...
      <p className="text-left pb-4 !text-white">Instructions are typically found under "Settings" → "Security and Privacy," though this may differ based on your browser.</p>
      <h4 className="my-2 !text-white">Changing Your Cookie Consent</h4>
      <p className="text-left pb-4 !text-white">You can update your cookie preferences by either deleting cookies from your browser or modifying your previous consent via this <a onClick={() => setPreferencesOpen(true)} className="text-royal-blue-500 hover:underline cursor-pointer">link</a>.</p>
      <CookiePreferences isOpen={preferencesOpen} onClose={() => setPreferencesOpen(false)} />
      <p className="text-left pb-4 !text-white"><strong>Note: </strong>If you use multiple browsers, you will need to adjust settings for each one individually.</p>
      <h4 className="my-2 !text-white">Have Questions?</h4>
      <p className="text-left !text-white">For inquiries or comments regarding our cookie policy or data processing practices, feel free to contact us using the form below.</p>
    </section>
  )
}