...
export async function Main() {
  return (
    <section id="terms-of-service" className="flex flex-col p-6 max-w-[1020px] text-navy-900">
      ...
      <h4 className="mt-6 mb-2 text-left text-navy-900">1. Conditions of Use</h4>
      ...
      <h4 className="mt-6 mb-2 text-left text-navy-900">2. Privacy Policy</h4>
      <p className="text-left text-navy-900">
      ...
      <h4 className="mt-6 mb-2 text-left text-navy-900">3. Intellectual Property</h4>
      <p className="text-left text-navy-900">
      ...
      <h4 className="mt-6 mb-2 text-left text-navy-900">4. Scope of Services</h4>
      <p className="text-left text-navy-900">
      ...
      <h4 className="mt-6 mb-2 text-left text-navy-900">4.1 Web Design & Development</h4>
      ...
      <h4 className="mt-6 mb-2 text-left text-navy-900">4.2 Branding</h4>
      <ul className="list-disc pl-6 mt-2">
      ...
      <h4 className="mt-6 mb-2 text-left text-navy-900">4.3 Hosting Services</h4>
      <ul className="list-disc pl-6 mt-2">
      ...
      <h4 className="mt-6 mb-2 text-left text-navy-900">5. Payments & Refunds</h4>
      <ul className="list-disc pl-6 mt-2">
      ...
      <h4 className="mt-6 mb-2 text-left text-navy-900">6. Communications</h4>
      <p className="text-left text-navy-900">
      ...
      <h4 className="mt-6 mb-2 text-left text-navy-900">7. Limitations of Liability</h4>
      <p className="text-left text-navy-900">
      ...
      <h4 className="mt-6 mb-2 text-left text-navy-900">8. Dispute Resolution</h4>
      <p className="text-left text-navy-900">
      ...
      <h4 className="mt-6 mb-2 text-left text-navy-900">9. User Conduct & Content</h4>
      <p className="text-left text-navy-900">
      ...
      <h4 className="mt-6 mb-2 text-left text-navy-900">10. Termination</h4>
      <p className="text-left text-navy-900">
      ...
      <h4 className="mt-6 mb-2 text-left text-navy-900">11. Changes to Terms</h4>
      <p className="text-left text-navy-900">
      ...
      <h4 className="mt-6 mb-2 text-left text-navy-900">12. Contact Us</h4>
      <p className="text-left text-navy-900">
