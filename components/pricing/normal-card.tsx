  ...
  return (
    <div className="flex h-auto items-center gap-[40px] justify-center">
      <div className="flex flex-col w-[250px] lg:w-[300px] h-[506px] lg:h-[575px] justify-start bg-mobile-normal-bg bg-center bg-cover">
        ...
        <div className='flex flex-col items-stretch h-[447px] lg:h-[525px] pb-16'>
          <div className='pl-12 lg:pl-14 flex flex-col self-stretch grow'>
            <div className='-mt-6 lg:-mt-12'>
              <div className="flex flex gap-1 items-end transition-opacity duration-500 opacity-100">
                ...
                <p className='font-maven-pro text-[#848199] text-[11px] lg:text-[14px] pb-1'>
                  /month
                </p>
              </div>
            </div>
            ...
            <div className='flex flex-col pt-2 grow'>
              <div className="fade-text">
                <h4 className='self-stretch font-maven-pro text-[20px] lg:text-[24px] text-[#231D4F] font-semibold'>
                  {planName}
                </h4>
                <p className='font-maven-pro text-[#848199] text-[11px] lg:text-[14px] pr-10 lg:pr-12'>
                  {planDescription}
                </p>
              </div>
              <div className='flex flex-col py-4 justify-between grow'>
                {features.map((feature, index) => (
                  <div key={index} className='flex gap-2 items-center pr-10 lg:pr-12 leading-4 fade-text'>
                    <Image 
                      ...
                      className=""
                    />
                    <p className='font-maven-pro text-[#848199] text-[12px] lg:text-[14px] capitalize'>
                      {feature}
                    </p>
                  </div>
                ))}
