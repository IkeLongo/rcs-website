  ...
  return (
    <section className='px-6 pb-8 max-w-[60em]'>
      ...
      <ul className="list-disc pl-6 mt-4 flex flex-col gap-2">
        <li><a href="https://support.microsoft.com/en-us/windows/manage-cookies-in-microsoft-edge-view-allow-block-delete-and-use-168dab11-0753-043d-7c16-ede5947fc64d#ie=ie-11" className="text-blue-500 hover:underline">Internet Explorer</a></li>
        <li><a href="https://support.microsoft.com/en-us/windows/manage-cookies-in-microsoft-edge-view-allow-block-delete-and-use-168dab11-0753-043d-7c16-ede5947fc64d" className="text-blue-500 hover:underline">Microsoft Edge</a></li>
        <li><a href="https://support.mozilla.org/en-US/kb/clear-cookies-and-site-data-firefox?redirectslug=delete-cookies-remove-info-websites-stored&redirectlocale=en-US" className="text-blue-500 hover:underline">Mozilla Firefox</a></li>
        <li><a href="https://support.google.com/chrome/answer/95647?hl=en" className="text-blue-500 hover:underline">Google Chrome</a></li>
        <li><a href="https://help.opera.com/en/latest/web-preferences/#cookies" className="text-blue-500 hover:underline">Opera</a></li>
        <li><a href="https://support.apple.com/en-us/105082" className="text-blue-500 hover:underline">Safari</a></li>
        <li><a href="https://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager07.html" className="text-blue-500 hover:underline">Flash cookies</a></li>
        <li><a href="https://support.apple.com/en-us/105082" className="text-blue-500 hover:underline">Apple</a></li>
        <li><a href="https://discover.hubpages.com/technology/How-to-delete-internet-cookies-on-your-Droid-or-any-Android-device" className="text-blue-500 hover:underline">Android</a></li>
        <li><a href="https://support.google.com/chrome/answer/95647?co=GENIE.Platform%3DAndroid&hl=en" className="text-blue-500 hover:underline">Chrome, Android</a></li>
      </ul>
      ...
      <p className="mt-4">You can update your cookie preferences by either deleting cookies from your browser or modifying your previous consent via this <a onClick={() => setPreferencesOpen(true)} className="text-blue-500 hover:underline cursor-pointer">link</a>.</p>
