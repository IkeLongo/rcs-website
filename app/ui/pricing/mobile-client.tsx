...
import { MobileClientProps } from "@/types/components";

export default function MobileClient({ selectedIndex }: MobileClientProps) {
  ...
  useEffect(() => {
    ...
    if (scrollContainer && scrollPosition === null) {
      ...
      const initialScrollPosition =
        ((scrollContainer?.scrollWidth ?? 0) - (scrollContainer?.clientWidth ?? 0)) / 2;
