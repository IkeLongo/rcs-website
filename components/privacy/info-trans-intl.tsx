...
export async function InfoTranIntl() {
  return (
    <section id="is-your-information-transferred-internationally" className="mt-8">
      <h3>8. Is Your Information Transffered Internationaly?</h3>
