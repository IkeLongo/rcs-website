...
const SITE_NAME_VAR = process.env.NEXT_PUBLIC_SITE_URL ?? "https://rivercitycreatives.com";
const BUSINESS_LOCATION = process.env.NEXT_PUBLIC_BUSINESS_LOCATION ?? "San Antonio, Texas, United States of America";
