  ...
  return (
    <div className="flex flex-col w-full items-center">
      ...
      <div id="block-1" className={`flex flex-col w-full items-center px-4 py-[45px] gap-[37px] ${selectedBlock === 'block-1' ? 'block' : 'hidden'}`}>
        ...
        <h4 className={`text-center w-full font-maven-pro font-bold text-[24px] drop-shadow-[2px_10px_4.6px_rgba(0,0,0,0.25)] delay-5 ${isTransitioning ? 'slide-out-left-1' : 'initial-offscreen slide-in-right'}`}>
