...
export default function LightBlueBlock({ iconRoute, iconDescription, iconWidth, title, bgImageClass, blockId, onClick, top }: BlockProps) {
  ...
  return (
    (<div className={`group flex flex-col w-full aspect-square items-center justify-center gap-[10px] ${bgImageClass} bg-center cursor-pointer`} onClick={onClick}>
      <div
        id={blockId}
