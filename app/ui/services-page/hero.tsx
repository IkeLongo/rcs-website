...
export async function Hero() {
  ...
  return (
    <div className="relative flex flex-col w-full h-[725px] overflow-x-hidden md:-top-0 bg-white">
      <div className="absolute w-full h-full flex self-end bg-service-hero-bg-blob bg-bottom-right bg-no-repeat overflow-x-hidden -mr-1 md:-top-0 lg:hidden"></div>
      <div className="hidden lg:block lg:absolute lg:-top-16 lg:w-full lg:h-full lg:flex lg:self-end lg:bg-service-hero-blob-desktop-svg lg:bg-right lg:bg-auto lg:bg-no-repeat lg:overflow-x-hidden lg:-mr-1 lg:bg-right-bottom"></div>
        ...
        <div className="absolute top-28 right-6 h-auto flex flex-col self-end gap-4 md:left-[15%] md:right-auto md:top-60 md:gap-10 lg:left-[10%] lg:top-44 lg:w-[482px] xl:left-[25%]">
          <div className="flex flex-col align-self-end w-68 gap-4">
            <h1 className='font-bold text-right leading-9 md:text-left lg:text-[46px] lg:leading-[3.5rem] text-navy-500'>
              Turn Your <span className='italic text-white'>Website</span><br/>& <span className='italic text-white'>Brand</span> into Your<br/>Top Sales Tools
            </h1>
