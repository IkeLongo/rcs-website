...
export async function Virginia() {
  return (
    <section id="do-virginia-residents-have-specific-privacy-rights" className="mt-8">
      ...
      <p className="mt-4">{DBA_NAME} has not sold any personal data to third parties for business or commercial purposes. {DBA_NAME} will not sell personal data in the future belonging to website visitors, users, and other consumers. </p>
      ...
      <p className="mt-4">You may contact us by email at{' '}
        <a href={`mailto:${BUSINESS_EMAIL}`} className="text-blue-400 hover:underline">
          {BUSINESS_EMAIL}
        </a>, by visiting <a href="#dpo-contact-form" className="text-blue-400 hover:underline">our Contact Form</a>, or by referring to the contact details at the bottom of this document.</p>
      ...
      <p className="mt-4">If we decline to take action regarding your request, we will inform you of our decision and reasoning behind it. If you wish to appeal our decision, please email us at{' '}
        <a href={`mailto:${BUSINESS_EMAIL}`} className="text-blue-400 hover:underline">
          {BUSINESS_EMAIL}
