...
export default function Process() {
  ...
  return (
    <div className='md:h-[1000px]'>
      <div className='relative top-20 flex flex-col gap-[16px] bg-white mx-4 px-[34px] py-[20px] rounded-[10px] shadow-[-11px_15px_7.5px_0_rgba(0,0,0,0.25)] z-10 md:-top-10'>
        <div>
      ...
      <div className="relative flex flex-col w-full h-auto px-4 pt-[150px] pb-[50px] gap-14 bg-gray-800 overflow-x-hidden z-5 md:-top-32 md:px-20">
        <div className='flex flex-col gap-4'>
        ...
        <div className='flex flex-col px-4 gap-[50px] md:hidden'>
        ...
        <div className='hidden md:block md:flex md:flex-col md:px-4 md:gap-20'>
