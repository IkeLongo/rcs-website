...
import { SocialLogins } from '@/app/ui/privacy/social-logins';
...
export default function Home() {
  ...
  return (
    <div className="base bg-alice-blue-500 flex flex-col justify-center items-center min-h-screen">
      <div className="relative h-auto w-full max-w-[1020px] bg-cover bg-top overflow-x-hidden top-24 mb-24 px-4">
        <div className="flex flex-col justify-center items-center">
          <header className="text-center py-8">
            <h1 className="text-navy-975 font-gentium-book-plus font-bold text-lg lg:text-xl text-center">Website Privacy Policy</h1>
            <p className="text-navy-975 !text-center">Last updated June 4, 2025</p>
          </header>
      ...
      <div className="relative flex flex-col justify-center items-center w-full h-auto px-10 pb-10 bg-navy-800 overflow-visible shrink-0 md:-top-0 text-white font-avenir tracking-wide">
        <div id="cookie-policy" className="text-center py-8 max-w-[60em]">
          ...
          <p className="!text-white !text-center">Last updated June 11, 2025</p>
        </div>
        <Cookies />
      </div>
