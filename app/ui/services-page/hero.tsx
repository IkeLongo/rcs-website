...
export async function Hero() {
  ...
  return (
    <div className="relative flex flex-col w-full h-[775px] overflow-x-hidden md:-top-0">
      <div className="absolute -top-16 w-full h-full flex self-end bg-service-hero-blob-svg bg-right bg-auto bg-no-repeat overflow-x-hidden -mr-1 md:-top-0 lg:hidden"></div>
