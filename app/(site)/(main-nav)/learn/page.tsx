import { GridPatternContainer } from "@/app/ui/components/blogs/blogTemplate";
import { BlogCard } from "@/app/ui/components/blogs/blogTemplate";
...
export default async function SimpleBlogWithGrid() {
  ...
  return (
    <div className="base relative overflow-hidden py-20 md:py-0">
      <div className="relative overflow-hidden mx-auto pt-20 pb-10">
        <GridPatternContainer className="opacity-20" />
        <div className="relative z-20 pt-20 pb-10 max-w-7xl mx-auto px-4 md:px-8">
          <h1
            className={cn(
              "mb-6 scroll-m-20 !text-5xl !text-left font-bold !text-white",
            )}
          >
            Learn
          </h1>

          <p className="text-neutral-400-foreground !mb-6 max-w-xl !text-left !font-maven-pro !text-md2 text-neutral-600">
